...
public class SequenceAnnotationToFeatureTest {
	...
	public void TestSBOL2SequenceAnnotation() throws Exception {
		...
		TestUtil.runTestSuiteFile(new File("../SBOLTestSuite/SBOL2/CD_SA_Range_Example.xml"));
		//TestUtil.runTestSuiteFile(new File("../SBOLTestSuite/SBOL2/CD_SA_Cut_Example.xml"));
