...
public class FunctionalComponentToSubComponentConverter implements ChildEntityConverter<org.sbolstandard.core2.FunctionalComponent, SubComponent> {

	@Override
	public SubComponent convert(SBOLDocument document, Identified sbol3Parent,
			org.sbolstandard.core2.Identified sbol2Parent, org.sbolstandard.core2.FunctionalComponent sbol2FunctionalComponent)
		...
		if(sbol3ChildComponent == null) {
			throw new SBOLGraphException("Could not find Component for FunctionalComponent: " + sbol2FunctionalComponent.getDefinition().getIdentity());
		}
