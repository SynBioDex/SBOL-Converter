...
public class ModelConverter implements EntityConverter<org.sbolstandard.core2.Model, Model>  {
    ...
    @Override
    public Model convert(SBOLDocument doc, org.sbolstandard.core2.Model input, Parameters parameters) throws SBOLGraphException {
    	// TODO: need to convert framework/language URIs
    	// TODO: should swap Language and Framework order to match libSBOLj
        Model mod = doc.createModel(Util.createSBOL3Uri(input),Util.getNamespace(input),Util.createSBOL3Uri(input.getSource()), Util.getSBOL3ModelFramework(input.getFramework()),
