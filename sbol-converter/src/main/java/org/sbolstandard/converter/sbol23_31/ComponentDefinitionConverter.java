...
public class ComponentDefinitionConverter implements EntityConverter<ComponentDefinition, Component> {
	...
	@Override
	public Component convert(SBOLDocument doc, ComponentDefinition input)
		...
		Component comp = doc.createComponent(Util.createSBOL3Uri(input), Util.getNamespace(input),
